    ...
    return (
        <>
            <main className="relative bg-black z-50">
                        ...
                        <div className="max-w-5xl sm:grid sm:grid-cols-2 flex flex-col items-start gap-12 z-50">
                            <div className="flex flex-col gap-4 sm:gap-16 text-left text-white">
                                ...
                                <div className="flex flex-col gap-4">
                                    <p className="opacity-90 text-lg underline">Tenha acesso ao planejamento <br />previdenciário por um especialista:</p>
                ...
                <Section classNameS="relative sm:py-32 py-12 px-4 border-y-4 border-white/20">
                    <Image
                        src="/images/bg2.png"
                        layout="fill"
                        alt=""
                ...
                <section className="relative sm:py-24 py-12 bg-zinc-950 px-4">
                    <div className="flex flex-col items-center gap-4 sm:gap-12">
                        <div className="flex flex-col sm:items-center gap-2 text-center">
                            ...
                            <p className="font-thin sm:text-2xl opacity-90 text-white ">Clique e confira os depoimentos:</p>
                        </div>
                        <div className="w-full sm:h-[550px] sm:py-12 flex sm:flex-row flex-col items-center justify-center">
                ...
                <Section classNameS="relative sm:h-[960px] sm:pt-0 sm:pb-12 pb-12 pt-4">
                    <Image
                        src="/images/bg3.png"
                        layout="fill"
                        alt=""
                        ...
                        loading="eager"
                    />
                    <div className="h-96 block sm:hidden rounded-xl">
                        <Image
                            src="/images/bg3-sm.png"
                            alt=""
                            width={400}
                            height={400}
                            objectFit="contain"
                    ...
                    <div className="flex flex-col gap-20 items-center px-4">
                        <div className="max-w-7xl sm:grid sm:grid-cols-3 sm:gap-12 flex flex-col items-start gap-8 z-50">
