...
export function ButtonWpp({ children }: { children: ReactNode }) {
    return (
        <button className="relative sm:w-[420px] uppercase sm:text-lg my-shadow-2 linear-2 rounded-full border border-[#FFD8BF] py-3 pe-8 ps-20 text-white font-semibold text-left">
